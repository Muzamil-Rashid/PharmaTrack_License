...
<body style="margin: 0; padding: 20px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #333333; line-height: 1.6; max-width: 600px;">
  
  <p style="font-size: 16px;">Dear ${safeName},</p>
  
  <p style="font-size: 16px;">Thank you for choosing PharmaTrack. Your software license has been successfully generated and is ready to use.</p>

  <div style="margin: 25px 0;">
    <p style="margin: 5px 0; font-size: 15px;"><strong>Plan Selected:</strong> ${planName}</p>
    <p style="margin: 5px 0; font-size: 15px;"><strong>Valid Until:</strong> ${expiryDate}</p>
    <p style="margin: 5px 0; font-size: 15px;"><strong>Request Code:</strong> <span style="font-family: monospace; word-break: break-all; color: #555555;">${requestCode}</span></p>
  </div>

  <p style="font-size: 16px; margin-bottom: 5px;"><strong>Your License Key:</strong></p>
  
  <div style="background-color: #f9fbfb; border-left: 4px solid #0E7C66; padding: 16px 20px; margin-bottom: 25px; border-radius: 0 4px 4px 0;">
    <div style="font-family: 'Courier New', Courier, monospace; font-size: 15px; font-weight: 600; color: #0A5C4C; word-break: break-all; line-height: 1.5;">
      ${licenseKey}
    </div>
  </div>

  <p style="font-size: 16px; font-weight: bold; margin-bottom: 10px; color: #0A5C4C;">How to Activate:</p>
  <ol style="font-size: 15px; padding-left: 20px; margin-top: 0; margin-bottom: 25px;">
    ...
    <li style="margin-bottom: 8px;">Copy the License Key above and paste it.</li>
    <li>Click on <strong>Activate Software</strong>.</li>
  </ol>

  <p style="font-size: 14px; color: #666666; margin-bottom: 25px; padding: 12px; background-color: #fcfcfc; border: 1px solid #eeeeee; border-radius: 4px;">
  ...
  <p style="font-size: 16px; font-weight: 600; margin-top: 0;">The PharmaTrack Team</p>
