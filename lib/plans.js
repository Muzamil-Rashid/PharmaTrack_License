...
// ==========================================================
const PLANS = {
  monthly:   { id: 'monthly',   name: 'Monthly Plan',   durationDays: 30,  amount: 399 },
  quarterly: { id: 'quarterly', name: 'Quarterly Plan', durationDays: 90,  amount: 999 },
  yearly:    { id: 'yearly',    name: 'Yearly Plan',    durationDays: 365, amount: 4999 },
};
